...
image::diagrams/bolt-vs-nams-data-flow.svg["Two lanes. Bolt: your application drives client-side embedding and entity-extraction providers and writes through the Bolt driver straight to a Neo4j instance you operate. NAMS: your application calls the hosted workspace over HTTPS; the workspace triggers background, server-side extraction that reaches an explicit not-yet-ready state until the readiness API reports it complete",width=100%,link=self]
