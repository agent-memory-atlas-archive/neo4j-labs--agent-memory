...
In 0.6.0, do not apply `detect_superseded_preferences` to a database that holds
...
superseding in xref:how-to/preferences.adoc[Store and revise a user preference] instead.
