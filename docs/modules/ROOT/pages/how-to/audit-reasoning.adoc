...
NOTE: This procedure requires Bolt. The Python NAMS client accepts
...
messages, see xref:explanation/graph-architecture.adoc[Why Neo4j? Graph memory architecture].
