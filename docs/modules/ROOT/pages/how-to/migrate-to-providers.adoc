...
Install both providers used above: `pip install "neo4j-agent-memory[anthropic,openai]"`. Set `ANTHROPIC_API_KEY` and `OPENAI_API_KEY` for the LLM and embeddings respectively.
