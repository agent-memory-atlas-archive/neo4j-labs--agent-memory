...
| A separate package (`@neo4j-labs/nams-ai-provider`) with four selectable modes — cross-session search, graph-expanded retrieval, explicit memory tools, and lifecycle hooks, all on the same NAMS backend.
