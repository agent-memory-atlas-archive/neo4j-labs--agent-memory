...
* Install: `pip install 'neo4j-agent-memory[anthropic,openai]==0.6.0' 'httpx>=0.27'`
...
[source,bash]
----
pip install 'neo4j-agent-memory[cli,mcp,anthropic,sentence-transformers]==0.6.0'
----
