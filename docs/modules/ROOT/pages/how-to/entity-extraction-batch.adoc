...
anchor:_batch_extraction[]anchor:_high_volume_ecommerce_speed_priority[]anchor:_financial_compliance_accuracy_priority[]
...
anchor:_streaming_extraction[]anchor:_get_complete_deduplicated_result[]anchor:_token_based_chunking[]
...
* xref:reference/extractors.adoc[Batch, stage, and streaming result models]
* xref:how-to/batch-processing.adoc[Document-processing tasks]
