...
* xref:how-to/typescript/authenticate.adoc[How-to: authenticate a TypeScript client]
...
* xref:how-to/typescript/handle-errors.adoc[How-to: handle TypeScript REST errors]
