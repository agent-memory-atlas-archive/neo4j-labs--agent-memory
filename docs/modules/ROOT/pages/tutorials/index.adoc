...
image::diagrams/tutorial-routes.svg["Three tutorial routes (Python and Aura, Python and NAMS, TypeScript and NAMS), each starting at a foundation lesson with solid arrows to continuations and dashed arrows to optional branches",width=100%,link=self]
